...
namespace Kendo.Mvc.Examples.Controllers
{
    public partial class SpreadProcessingController : Controller
    {
        ...
        private void PrepareGridDocument(Worksheet worksheet, int itemsCount, string headerColor, string rowColor)
        {
            ...
            ThemableColor headerBackground = new ThemableColor(TelerikMedia.Color.FromHex(headerColor));
            ThemableColor rowsBackground = new ThemableColor(TelerikMedia.Color.FromHex(rowColor));
