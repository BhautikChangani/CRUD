...
namespace Kendo.Mvc.Examples.Controllers
{
    public partial class ZipLibraryController : Controller
    {
        ...
        public string GetSampleDocument()
        {
            ...
            document.Load(Server.MapPath("~/Content/web/ziplibrary/BasicTools.xml"));
        ...
        public JsonResult Process_Document(string content, string compression)
        {
            ...
            return Json(new { content = compressedContent, label = compressedSize }, JsonRequestBehavior.AllowGet);
        }
    }
}
