...
namespace Kendo.Mvc.Examples.Controllers
{
    ...
    {
        private readonly Models.IDirectoryBrowser directoryBrowser;
        private readonly Models.IDirectoryPermission permission;
        private readonly IVirtualPathProvider pathProvider;

        protected BaseFileBrowserController(Models.IDirectoryBrowser directoryBrowser,
