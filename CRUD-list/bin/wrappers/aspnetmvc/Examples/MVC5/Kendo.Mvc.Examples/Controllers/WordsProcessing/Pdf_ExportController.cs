...
namespace Kendo.Mvc.Examples.Controllers
{
    public partial class WordsProcessingController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Download_Document_Pdf(HttpPostedFileBase customDocument)
        {
            ...
            {
                fileFormatProvider = new DocxFormatProvider();
                string fileName = Server.MapPath("~/Content/web/wordsprocessing/SampleDocumentPDF.docx");
