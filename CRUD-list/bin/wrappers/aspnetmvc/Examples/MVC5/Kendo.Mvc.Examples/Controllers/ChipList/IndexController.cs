...
{
    public partial class ChipListController : Controller
    {
        [Demo]
        public ActionResult Index()
        {
            var sushi = GetSushiData();
            return View(sushi);
        }
        public List<Sushi> GetSushiData()
        {
            string jsonString = @"[
            {
                 ""id"": 1,
            ...
            List<Sushi> sushi = JsonConvert.DeserializeObject<List<Sushi>>(jsonString);
            return sushi;
        }
    }
}
