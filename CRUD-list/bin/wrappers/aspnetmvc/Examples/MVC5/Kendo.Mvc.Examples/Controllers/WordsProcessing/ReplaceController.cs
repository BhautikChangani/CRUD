...
namespace Kendo.Mvc.Examples.Controllers
{
    public partial class WordsProcessingController : Controller
    {
        ...
        public ActionResult Download_Document_Replace(HttpPostedFileBase customDocument, string methodType, string findWord, string replaceWith, bool matchCase, bool matchWholeWord, bool regEx)
        {
