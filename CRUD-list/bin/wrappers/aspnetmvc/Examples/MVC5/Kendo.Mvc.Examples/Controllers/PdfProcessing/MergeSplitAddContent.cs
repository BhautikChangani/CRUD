...
using TelerikPrimitives = Telerik.Documents.Primitives;
...
namespace Kendo.Mvc.Examples.Controllers
{
    public partial class PdfProcessingController : Controller
    {
        ...
        private static RadFixedPage GenerateForegroundTextContent(string text)
        {
            ...
            foregroundContentOwner.Size = new TelerikPrimitives.Size(rotatedTextSquareSize, rotatedTextSquareSize);
